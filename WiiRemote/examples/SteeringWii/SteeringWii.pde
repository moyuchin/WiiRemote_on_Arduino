...
void setup()
{
  ...
  //unsigned char wiiremote_bdaddr[6] = {0x00, 0x1c, 0xbe, 0x1a, 0x52, 0xd2}; // 0x001cbe1a52d2
  //unsigned char wiiremote_bdaddr[6] = {0x00, 0x1f, 0x32, 0xfd, 0x65, 0x72}; // 0x001f32fd6572
  /*
